  ...
  describe("Custom Strategy", () => {
    ...
    test("can run execute", async () => {
      ...
      expect(JSON.stringify(parsedResult)).toStrictEqual(
        (`{"functionName":"tend(uint256,(int24[],int24[],uint16[]),bytes)","typesArray":["uint256","tuple(int24[],int24[],uint16[])","bytes"],"valuesArray":[10000,[[101880],[102000],[1]],"0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff000000000000000000000000ffffffffffffffffffffffffffffffffffffffff"]}`)
      );
    });
  });
});
